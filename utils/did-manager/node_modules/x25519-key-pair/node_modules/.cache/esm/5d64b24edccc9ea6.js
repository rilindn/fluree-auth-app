 ...
 */
'use strict';;let util,LDKeyPair,base58Decode,ed2curve,nacl;_dcc‍.x([["X25519KeyPair",()=>X25519KeyPair]]);_dcc‍.w("node-forge",[["util",["util"],function(v){util=v}]]);_dcc‍.w("crypto-ld",[["LDKeyPair",["LDKeyPair"],function(v){LDKeyPair=v}]]);_dcc‍.w("crypto-ld/lib/util",[["base58Decode",["base58Decode"],function(v){base58Decode=v}]]);_dcc‍.w("ed2curve",[["default",["ed2curve"],function(v){ed2curve=v}]]);_dcc‍.w("tweetnacl",[["default",["nacl"],function(v){nacl=v}]]);
